<template>
	<view class="login">
		<view class="content">
			<view class='goback iconfont icon-zuojiantou' @click='goback'></view>
			<!-- 头部logo -->
			<view class="header">
...
<script>
	var _this;
	import wInput from '../../common/watch-login/watch-input.vue' //input
	import wButton from '../../common/watch-login/watch-button.vue' //button
	...
	export default {
		...
		methods: {
		    ...
		    startLogin(){
				uni.request({
					url: 'http://122.51.43.172:3001/login',
					method: 'GET',
					data: {
					...
					success: res => {
						...
						}else if(this.phoneData === '' & this.passData === ''){
							uni.showToast({
								title:'请正确输入',
								icon:'none'
							})
...
<style>
	@import url("../../common/watch-login/css/icon.css");
